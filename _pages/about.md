...
Research Interests
======
I'm now looking to pursue research in spatial reasoning for multimodal LLMs, with a particular interest in multi-view and 3D scene representation. Current models often struggle with geometric grounding and hallucinate in 3D space, frequently relying on dataset answer-distribution bias and linguistic shortcuts rather than genuine spatial reasoning, and I want to work on closing this gap. I'm also interested in Vision-Language-Action models, where these same grounding failures translate directly into unreliable robot behavior.
